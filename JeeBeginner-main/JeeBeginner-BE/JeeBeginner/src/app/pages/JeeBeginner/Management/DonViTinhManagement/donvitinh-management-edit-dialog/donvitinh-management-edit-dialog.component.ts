  ...
  implements OnInit, OnDestroy
{
  ...
  this.donvitinhManagementService.isUpdateMode$.subscribe(value => {
  ...
  getTitle() {
    if (this.item.IdDVT === 0) {
      return this.translateService.instant('DONVITINHMANAGEMENT.THEMDONVITINH');
    }
    return this.translateService.instant('DONVITINHMANAGEMENT.SUADONVITINH');
  }
  goBack() {
    debugger
